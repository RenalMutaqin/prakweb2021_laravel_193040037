...
<div class="card mb-3">
  ...
  <div class="card-body text-center">
    <h3 class="card-title"> <a href="/posts/{{ $post[0]->id }}"class="text-decoration-none text-dark">{{ $posts[0]->title}}</a></h3>
    <p>
    ...
    <p class="card-text">{{ $posts[0]s[0]->excerpt}}</p>

    <a href="/posts/{{ $post[0]->id }}" class="text-decoration-none btn btn-primary">read more</a>
  </div>
</div>
